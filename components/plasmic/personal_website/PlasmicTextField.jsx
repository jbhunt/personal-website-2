...
import TextInput from "../../TextInput"; // plasmic-import: -mgESBaDj_0u/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: q0scRnaNoL9o/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: RWeJsPZNFSBM/css
...
function PlasmicTextField__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__eneWs, {
          [sty.freeBoxiconEnd__eneWsTwHth]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__eneWsKtIcw]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__eneWsG7CWd]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__qyucW, {
            [sty.freeBoxiconStart__qyucWKtIcw]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__qyucWg7CWd]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__qTtZe)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__q3ZJ6, {
            [sty.freeBoxiconEnd__q3ZJ6TwHth]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__q3ZJ6KtIcw]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__jxTzp)}
                role={"img"}
              />
            ),
