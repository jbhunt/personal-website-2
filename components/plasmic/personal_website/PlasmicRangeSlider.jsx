...
import SliderThumb from "../../SliderThumb"; // plasmic-import: XrGW2eRmEf-_/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: GFn_fXWRcRz7/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__jGqr3)}
      >
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__tac69)}>
        <div
