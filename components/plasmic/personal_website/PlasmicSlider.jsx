...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: N1ccNZ3hCLA3/css
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__psTrf)}
        >
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__mwJn3)}>
        <div
