...
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: z3P5HMBzjv0r/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__xaFl)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__dJ8Gn)}
            role={"img"}
          />
        ) : null}
      </div>
