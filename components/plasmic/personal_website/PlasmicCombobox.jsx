...
import MenuPopover from "../../MenuPopover"; // plasmic-import: 2jrz3M66yf_A/component
...
import sty from "./PlasmicCombobox.module.css"; // plasmic-import: pwvQDDVlpmry/css
...
function PlasmicCombobox__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox___6Ephr)}>
        {(() => {
          const child$Props = {
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__hbtri)}>
            <ChevronDownIcon
