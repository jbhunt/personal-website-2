      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__gWjvi)}
          >
            <Radio
              className={classNames("__wab_instance", sty.radio__nn5H4)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__tqenC)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__xMsEb)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
