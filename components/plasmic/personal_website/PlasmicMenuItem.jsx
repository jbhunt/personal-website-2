...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: EJWfBAiUq7zB/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__dhTt)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__jRxq5)}>
            <div
              className={classNames(
                projectcss.all,
