...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: oVDnvLHcy-3j/css
...
function PlasmicRadio__RenderFunc(props) {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__kaWE)}>
        <div className={classNames(projectcss.all, sty.freeBox__hL8KN)} />
      </div>
      {renderPlasmicSlot({
